...
У цьому портфоліо представлені мої ключові проєкти, що демонструють знання .NET, веб-технологій, баз даних та десктопних додатків.
...
| [Guidance](https://guidance-sandy.vercel.app/) | Навчальний проєкт: клон сайту для бронювання житла з новим дизайном. Розробка серверної частини, API, управління базою даних, оптимізація продуктивності та обробка помилок. | C#, ASP.NET Core, MS SQL | [GitHub](https://github.com/AlexLiberty/GuidanceServer.git) |
...
| [Guidance](https://guidance-sandy.vercel.app/) | Educational project: a redesigned clone of an accommodation booking website. Developed backend functionality, API, database management, performance optimization, and error handling. | C#, ASP.NET Core, MS SQL | [GitHub](https://github.com/AlexLiberty/GuidanceServer.git) |
